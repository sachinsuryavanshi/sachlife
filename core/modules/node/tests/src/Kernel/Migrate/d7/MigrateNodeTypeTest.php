...
class MigrateNodeTypeTest extends MigrateDrupal7TestBase {
  ...
  public function testNodeType() {
    ...
    $this->assertEntity('article', 'Article', 'Use <em>article</em> for time-sensitive content like news, press releases or blog posts.', 'Help text for article', TRUE, FALSE, $expected_available_menus, $expected_parent, "Body");
