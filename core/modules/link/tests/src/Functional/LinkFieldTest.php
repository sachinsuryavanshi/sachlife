...
class LinkFieldTest extends BrowserTestBase {
  ...
  public function testLinkFormatter() {
    ...
    $this->drupalGet('entity_test/add');
    $url1 = 'http://www.example.com/content/article/archive?author=John&year=2012#com';
    $url2 = 'http://www.example.org/content/article/archive?author=John&year=2012#org';
    $url3 = '#net';
    $title1 = $url1;
