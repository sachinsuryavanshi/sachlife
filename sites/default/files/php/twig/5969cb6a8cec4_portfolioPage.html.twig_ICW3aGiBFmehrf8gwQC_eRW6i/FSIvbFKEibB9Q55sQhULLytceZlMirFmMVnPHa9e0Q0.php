...
class __TwigTemplate_103b2e0ec6359e9f2d3c176b3f863e816890738c9695394921cb76357730d360 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $filters = array("length" => 2, "raw" => 17, "slice" => 17, "replace" => 86);
        $functions = array("file_url" => 12);

        try {
            $this->env->getExtension('sandbox')->checkSecurity(
                array('if', 'for'),
                array('length', 'raw', 'slice', 'replace'),
                array('file_url')
            );
          ...
          <div class=\"col-left col-md-4 col-lg-3\">
            ...
            if ((twig_length_filter($this->env, $this->getAttribute((isset($context["content"]) ? $context["content"] : null), "category", array())) > 0)) {
                ...
                foreach ($context['_seq'] as $context["keyCat"] => $context["valCat"]) {
                    ...
                    echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $context["valCat"], "html", null, true));
                    echo "</a></span>
                        ";
                }
            ...
            if ((twig_length_filter($this->env, $this->getAttribute((isset($context["content"]) ? $context["content"] : null), "photographsTags", array())) > 0)) {
                ...
                foreach ($context['_seq'] as $context["keyTag"] => $context["valTag"]) {
                    // line 51
                    echo "                          <span class=\"info\"><a href=\"#\">";
                    echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $context["valTag"], "html", null, true));
                    echo "</a></span>
                        ";
                }
                $_parent = $context['_parent'];
          ...
          <div class=\"col-right col-md-8 col-lg-9\">
            ...
            if ((twig_length_filter($this->env, $this->getAttribute((isset($context["content"]) ? $context["content"] : null), "photographs", array())) > 0)) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["keyPhoto"]) {
                    ...
                    // line 122
                    echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute($context["keyPhoto"], "alt", array()), "html", null, true));
                    echo "</h5>
                            </div>
                          </a>
                        </div>
  ...
  ";
    ...
    {
        return "<section id=\"content-section\" class=\"portfolio-single portfolio-single-5\">
  {% if content|length > 0 %}
            ...
            <div class=\"portfolio-info\">
              <div class=\"portfolio-info-inner\">
                ...
                <div class=\"author\">
                  ...
                  <a href=\"\" class=\"author-info\">- Author: {{ content.author }}</a>
                </div>
                <div class=\"album-description margin-top-20\">
                  <div class=\"al-desc-inner\">
                ...
                <div class=\"portfolio-atr margin-top-50\">
                  <ul class=\"list-unstyled\">
                    {% if content.category|length > 0 %}
                      <li>
                        <h4 class=\"head\">Category:</h4>
                        {% for keyCat,valCat in content.category %}
                          <span class=\"info\"><a href=\"#\">{{ valCat }}</a></span>
                        {% endfor %}
                      </li>
                    {% endif %}

                    {% if content.photographsTags|length > 0 %}
                      <li>
                        <h4 class=\"head\">Tags:</h4>
                        {% for keyTag,valTag in content.photographsTags %}
                          <span class=\"info\"><a href=\"#\">{{ valTag }}</a></span>
                        {% endfor %}
                      </li>
                    {% endif %}
                ...
                <ul class=\"album-attributes\">
                  ...
                  {% if content.nodeNextNavigation|length > 0 %}
                    {% for keyNext in content.nodeNextNavigation %}
                      <li class=\"portfolio-nav pull-right\">
                        <a href=\"/portfolio/{{ keyNext.nid }}/{{ keyNext.title|replace({' ':'-'}) }}\"
                           class=\"pn-link portf-next\" title=\"Next work\">
                          <span class=\"pn-link-text hide-from-sm\">Next</span>
                          <span class=\"pn-link-icon\"><i class=\"fa fa-chevron-right\"></i></span>
                        </a>
                  ...
                  {% if content.nodePrevNavigation|length > 0 %}
                    {% for keyPrev in content.nodePrevNavigation %}
                      <li class=\"portfolio-nav pull-right\">
                        <a href=\"/portfolio/{{ keyPrev.nid }}/{{ keyPrev.title|replace({' ':'-'}) }}\"
                           class=\"pn-link portf-prev margin-right-15\"
                           title=\"Previous work\">
                          <span class=\"pn-link-icon\"><i class=\"fa fa-chevron-left\"></i></span>
                          <span class=\"pn-link-text hide-from-sm\">Prev</span>
              ...
              <div id=\"gallery\" class=\"isotope-items-wrap lightgallery\">
                ...
                {% if content.photographs|length > 0 %}
                  {% for keyPhoto in content.photographs %}
                    <div class=\"isotope-item sachlife\">
                      <div class=\"album-single-item\">
                        <img class=\"asi-img\" src=\"{{ file_url(keyPhoto.target_id) }}\" alt=\"image\">
                        <div class=\"asi-cover\">
                          <a class=\"asi-link lg-trigger\" href=\"{{ file_url(keyPhoto.target_id) }}\"
                             data-exthumbnail=\"{{ file_url(keyPhoto.target_id) }}\"
                             data-sub-html=\"<h4>{{ keyPhoto.title }}</h4>
                             <p>{{ keyPhoto.title }}</p>\">
                            <div class=\"asi-info\">
                              <h2 class=\"asi-title\">{{ keyPhoto.title }}</h2>
                              <h5 class=\"asi-sub-title\">#{{ keyPhoto.alt }}</h5>
                            </div>
                          </a>
                        </div>
                      </div>
